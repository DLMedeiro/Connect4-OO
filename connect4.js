...
class Game {
  ...
  makeHtmlBoard() {
    const boardSpace = document.getElementById('game')
    const board = document.getElementById('board');
    board.innerHTML = '';
    boardSpace.classList.add('game');
    ...
    top.setAttribute('id', 'column-top');
      ...
      this.handleGameClick = this.handleClick.bind(this);
        // *the 'this' in "this.handleGameClink" = the same as in the constructor
        // this(1).handleClick.bind(this(2))
          // this(1) = this from the Game Class
          // this(2) = this from handleClick
